...
num1 = int(input("Enter the first number (between 1 and 999): "))
num2 = int(input("Enter the second number (between 1 and 999): "))

if num1 <= num2:
    print("Error here: the first number must be greater than the second one.")
else:
    ...
    while user_number < 3 or user_number > 7:
        user_number = int(input("It's invalid. Enter a number between 3 and 7: "))
    ...
    for i in range(8):
        user_number = int(input(f"Enter a number between 3 and 7 for the password {i + 1}: "))
    ...
    # For part A
    dictionary_a = {i: (i - 1) * i for i in range(1, 31)}
    print(dictionary_a)
    ...
    for value in dictionary_a.values():
        sum_a += value
    print(f"Sum of all values: {sum_a}")

    # For part D
    user_number = int(input("Enter a number: "))
    if user_number in dictionary_a:
        del dictionary_a[user_number]
        print(f"Dictionary after removing item with key {user_number}: {dictionary_a}")
    else:
